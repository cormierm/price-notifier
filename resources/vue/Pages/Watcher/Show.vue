<template>
    <div class="p-4">
        ...
        <article class="border rounded mt-4 dark:border-gray-700">
            <div class="p-4 bg-gray-200 dark:bg-gray-700">
                ...
                <a class="text-blue-500 dark:text-blue-400 text-sm" :href="watcher.url">{{ watcher.url }}</a>
            </div>
            <div class="flex flex-col md:flex-row p-4 gap-8">
                <div class="w-full md:w-2/3 m-h-[800px] dark:bg-gray-900">
        ...
        <div class="flex mt-4 gap-4">
            <article class="border rounded w-1/2 dark:border-gray-700">
                <div class="text-lg font-bold p-4 bg-gray-200 dark:bg-gray-700">
                    Query
                </div>
                <div class="m-4">
